...
public class SubjectController {
    ...
    @PutMapping()
    @PreAuthorize("hasAnyRole('DIRETOR')")
    public ResponseEntity<Response<Subject>> update(HttpServletRequest request, @RequestBody Subject subject, BindingResult result) {
        Response<Subject> response = new Response<Subject>();
        try {
    ...
    @PreAuthorize("hasAnyRole('DOCENTE', 'DIRETOR')")
    public ResponseEntity<Response<Page<Subject>>> findAll(HttpServletRequest request, @PathVariable int page, @PathVariable int count) {
